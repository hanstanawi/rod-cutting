...
window.onload = function() {
    ...
    document.querySelector("button").addEventListener("click", function(){
        ...
        document.querySelector("#rev").textContent = bruteForce(price, userLength); //displaying the result of the bruteforce function to count the max revenue
        ...
        console.log("Maximum Revenue: " + bruteForce(price, userLength)); //print out the maximum revenue result on the console
      });
}
